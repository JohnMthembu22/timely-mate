...
export const DEMO_EMPLOYEES: Employee[] = [
  ...
  },
  {
    ...
    joinDate: '2023-08-12',
    status: 'active',
    avatar: 'https://i.pravatar.cc/150?u=demo-emp-6',
    salary: 78000,
    benefits: ['Health', 'Travel'],
    level: 'lead',
    email: 'jordan.mbeki@demo.timelymate.app',
    employmentType: 'permanent',
    workLocation: 'offsite',
  },
  {
    id: 'demo-emp-7',
    name: 'Sarah Naidoo',
    ...
    joinDate: '2024-04-01',
    status: 'active',
    avatar: 'https://i.pravatar.cc/150?u=demo-emp-7',
    salary: 68000,
    benefits: ['Health'],
    level: 'mid',
    email: 'sarah.naidoo@demo.timelymate.app',
    employmentType: 'permanent',
    workLocation: 'offsite',
  },
  {
    ...
    joinDate: '2024-01-20',
    status: 'active',
    avatar: 'https://i.pravatar.cc/150?u=demo-emp-8',
    salary: 71000,
    benefits: ['Health'],
    level: 'senior',
    email: 'priya.patel@demo.timelymate.app',
