...
const Procurement: React.FC = () => {
  ...
  // Persist vendors to localStorage so users can add custom vendors
  useEffect(() => {
    try {
      const saved = localStorage.getItem('timelymate_procurement_vendors');
      if (saved) {
  ...
  useEffect(() => {
    try {
      localStorage.setItem('timelymate_procurement_vendors', JSON.stringify(vendors));
    } catch {}
  }, [vendors]);
  ...
  const handleAddonsTabChange = (_: React.SyntheticEvent, newValue: number) => {
  ...
  const handleCreatePO = () => {
    ...
    const calculatedTotal = newPO.items.reduce((sum, item) => sum + item.totalPrice, 0);
    const finalTotal = newPO.totalAmount > 0 ? newPO.totalAmount : calculatedTotal;
  ...
  const handleCreateVendor = () => {
    // Validate required fields before creating vendor
    const isValidEmail = (val: string) => /.+@.+\..+/.test(val);
    const isValid =
      newVendor.name.trim().length > 0 &&
      newVendor.contactPerson.trim().length > 0 &&
      isValidEmail(newVendor.email) &&
      newVendor.phone.trim().length > 0 &&
      newVendor.address.trim().length > 0 &&
      newVendor.category.trim().length > 0 &&
      newVendor.paymentTerms.trim().length > 0 &&
      Number.isFinite(newVendor.leadTime) && newVendor.leadTime > 0;

    if (!isValid) {
      addNotification(createNotification.procurement(
        'Incomplete Vendor Details',
        'Please fill in all vendor fields with valid information before saving.'
      ));
      return;
    }
    ...
    // If creating from a PO flow, select the newly added vendor
    setNewPO(prev => ({ ...prev, vendorId: newVendorData.id }));
    setNewVendor({
      name: '',
      contactPerson: '',
      email: '',
  ...
  const handleImportData = async () => {
    ...
    if (!importData) {
      console.log('No import data available');
      return;
    }
  ...
  return (
    <DashboardLayout>
      <FeatureGuard feature="procurement">
        <Box sx={{ minHeight: '100vh', bgcolor: 'background.default' }}>
            ...
            <DialogContent>
              <Stack spacing={3} sx={{ mt: 2 }}>
                <FormControl fullWidth>
                  ...
                  >
                    <MenuItem value="__add_new_vendor__" onClick={() => setOpenNewVendor(true)}>
                      + Add new vendor
                    </MenuItem>
                    <Divider />
                    {vendors.map((vendor) => (
                ...
                <TextField
                  ...
                  helperText="Enter the total amount for this purchase order"
                />
                <TextField
                  label="Notes"
                  fullWidth
          ...
          <Dialog 
            open={openNewVendor} 
            onClose={() => setOpenNewVendor(false)} 
            maxWidth="sm" 
            fullWidth
            PaperProps={{
              sx: {
          ...
          >
              ...
              <Stack spacing={3} sx={{ mt: 2 }}>
                ...
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    <MenuItem value="Hardware & Electronics">Hardware & Electronics</MenuItem>
                    <MenuItem value="Office Supplies">Office Supplies</MenuItem>
                    <MenuItem value="Furniture & Equipment">Furniture & Equipment</MenuItem>
                    <MenuItem value="Industrial">Industrial</MenuItem>
                    <MenuItem value="Manufacturing">Manufacturing</MenuItem>
                    <MenuItem value="Automotive">Automotive</MenuItem>
                    <MenuItem value="Aerospace & Defense">Aerospace & Defense</MenuItem>
                    <MenuItem value="Construction & Building">Construction & Building</MenuItem>
                    ...
                    <MenuItem value="Shipping & Freight">Shipping & Freight</MenuItem>
                    ...
                    <MenuItem value="Restaurants & Food Service">Restaurants & Food Service</MenuItem>
                    <MenuItem value="Hotels & Lodging">Hotels & Lodging</MenuItem>
                    ...
                    <MenuItem value="Facilities Management">Facilities Management</MenuItem>
                    <MenuItem value="Cleaning Services">Cleaning Services</MenuItem>
                    <MenuItem value="Maintenance & Repair">Maintenance & Repair</MenuItem>
                    <MenuItem value="Government & Public Sector">Government & Public Sector</MenuItem>
                    <MenuItem value="Non-Profit">Non-Profit</MenuItem>
                    <MenuItem value="Charity & Social Services">Charity & Social Services</MenuItem>
                    <MenuItem value="Religious Organizations">Religious Organizations</MenuItem>
                    <MenuItem value="Arts & Culture">Arts & Culture</MenuItem>
                    <MenuItem value="Museums & Galleries">Museums & Galleries</MenuItem>
                    <MenuItem value="Theater & Performing Arts">Theater & Performing Arts</MenuItem>
                    <MenuItem value="Music">Music</MenuItem>
                    <MenuItem value="Film & Television Production">Film & Television Production</MenuItem>
                    <MenuItem value="Photography">Photography</MenuItem>
                    <MenuItem value="Design & Creative Services">Design & Creative Services</MenuItem>
                    <MenuItem value="Architecture">Architecture</MenuItem>
                    <MenuItem value="Engineering">Engineering</MenuItem>
                    <MenuItem value="Scientific Research">Scientific Research</MenuItem>
                    <MenuItem value="Laboratory Services">Laboratory Services</MenuItem>
                    <MenuItem value="Testing & Inspection">Testing & Inspection</MenuItem>
                    <MenuItem value="Quality Assurance">Quality Assurance</MenuItem>
                    <MenuItem value="Packaging">Packaging</MenuItem>
                    <MenuItem value="Printing & Publishing">Printing & Publishing</MenuItem>
                    <MenuItem value="Textiles">Textiles</MenuItem>
                    <MenuItem value="Apparel Manufacturing">Apparel Manufacturing</MenuItem>
                    <MenuItem value="Footwear">Footwear</MenuItem>
                    <MenuItem value="Jewelry">Jewelry</MenuItem>
                    <MenuItem value="Cosmetics & Personal Care">Cosmetics & Personal Care</MenuItem>
                    ...
                    <MenuItem value="Books & Publishing">Books & Publishing</MenuItem>
                    ...
                    <MenuItem value="IoT (Internet of Things)">IoT (Internet of Things)</MenuItem>
            ...
            <DialogActions sx={{ 
              ...
              <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
                <Button 
                  onClick={() => setOpenNewVendor(false)}
                  sx={{
                    borderRadius: 2,
                    px: 3,
                    py: 1.5,
          ...
          <Dialog 
            ...
            onClose={() => setOpenNewInventory(false)} 
            maxWidth="sm" 
            fullWidth
            PaperProps={{
              sx: {
          ...
          >
            ...
            <DialogActions sx={{ 
              ...
              <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
                <Button 
                  onClick={() => setOpenNewInventory(false)}
                  sx={{
                    borderRadius: 2,
                    px: 3,
                    py: 1.5,
                      ...
                      <Box sx={{ mt: 2 }}>
                        {index < importSteps.length - 1 && (
                          <Button
                            variant="contained"
                            onClick={() => {
                              if (index === importSteps.length - 2) {
                                // This is the final step before import, trigger the actual import
                                handleImportData();
                              } else {
          ...
          >
            ...
            <DialogActions sx={{ 
              ...
              <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
                <Button 
                  onClick={() => setOpenAddonsDialog(false)}
                  sx={{
                    borderRadius: 2,
                    px: 3,
                    py: 1.5,
          ...
          <Dialog 
            open={openViewInventory} 
            onClose={() => setOpenViewInventory(false)} 
            maxWidth="md" 
            fullWidth
            PaperProps={{
              sx: {
          ...
          >
            ...
            <DialogActions sx={{ 
              ...
              <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
                <Button 
                  onClick={() => setOpenViewInventory(false)}
                  sx={{
                    borderRadius: 2,
                    px: 3,
                    py: 1.5,
                ...
                <Button 
                  onClick={() => { setOpenViewInventory(false); handleEditInventory(selectedInventory!); }} 
                  variant="outlined"
                  sx={{
                    borderRadius: 2,
                    px: 3,
          ...
          >
                ...
                <Stack spacing={3} sx={{ mt: 2 }}>
                  ...
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      label="Status"
                      onChange={(e) => setEditingInventory({ ...editingInventory, status: e.target.value as 'in-stock' | 'low-stock' | 'out-of-stock' | 'discontinued' })}
                    >
            ...
            <DialogActions sx={{ 
              ...
              <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
                <Button 
                  onClick={() => setOpenEditInventory(false)}
                  sx={{
                    borderRadius: 2,
                    px: 3,
                    py: 1.5,
